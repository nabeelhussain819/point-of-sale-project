                    ...
                    <div class="card shadow-lg bg-white rounded"
                        ...
                        <div class="card-body text-center">
                            <div class="row">
                                ...
                                <div class="col">
                                    <h4 class="text-light mt-1" style="margin-top: 8px;color: #fff;">Product
                                        Manager</h4>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <a href="{{route('reconciliation.index')}}" style="color: #fff;">
                    <div class="card shadow-lg bg-white rounded"
                         style="height: 120px;background-image: linear-gradient(87deg, #ef3232  0%, #ff6666  100%); border-radius: .375rem;">
                        <div class="card-body text-center">
                            <div class="row">
                                <div class="col">
                                    <i class="fas fa-cubes text-light" style="font-size: 70px"></i>
