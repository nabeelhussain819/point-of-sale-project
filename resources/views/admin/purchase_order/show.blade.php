...
@section('content')
    ...
    <div class="container">
        <div class="card">
            ...
            <h5 class="card-header"><a href="#" class="badge badge-primary"> Purchase Order</a></h5>
            <div class="card-body">

                <div class="row">
                    <div class="card border-primary  bg-info  col-12 col-md-4">
                        <div class="card-header">Expected_date</div>
                        <div class="card-body text-primary">
                            <h5 class="card-title text-white">{{$purchaseOrder->expected_date}}</h5>
                    ...
                    <div class="card text-white border-secondary bg-warning   col-12 col-md-4">
                        ...
                        <div class="card-body text-white ">
                            <h5 class="card-title text-white">{{$purchaseOrder->received_date}}</h5>

                        </div>
                    </div>

                    <div class="card text-white border-secondary {{empty($purchaseOrder->received_date) ? 'bg-danger ':'bg-success'}}  col-12 col-md-4">
