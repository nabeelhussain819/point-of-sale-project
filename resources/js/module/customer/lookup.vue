<template>
    <a-card hoverable :bordered="false">
        ...
        <span v-else>
            <a-button slot="extra" @click="showModal(true)" type="link"
                >edit</a-button
            >
            <div slot="title">
                                    ...
                                    rules: [
                                        {
                                            required: true,
                                            message:
                                                'Please input your customer number!'
                                        }
                                    ]
                                }
                            ]"
...
export default {
    ...
    methods: {
        ...
        emitCustomerId(customer) {
            ...
            this.$nuxt.$emit(EVENT_CUSTOMERSALE_CUSTOMER_DETAIL, customer);
        ...
        onCustomerSelect(value, options) {
            ...
            if (
                ...
                !isEmpty(selectedCustomer.phone)
            ) {
