  ...
  <a-skeleton :loading="loading">
    ...
    >
      ...
      <a-row :gutter="16" v-for="(installment, key) in installments" :key="key">
        ...
        <a-col :span="3" v-if="isCreated">
          <a-button
            :disabled="!isEmpty(installment.received_amount)"
            @click="submitInstallment(key)"
            type="primary"
            >{{ !isEmpty(installment.received_amount) ? "Paid" : "Pay" }}
          </a-button>
        </a-col>
        <!-- After Update input fields -->
      </a-row>
      <a-row v-if="!isEmpty(installments)">
        <a-col
          ...
          >
            ...
            <span></span>
            <a-button v-if="!isCreated" @click="handleInstallments" type="primary"
              >Create
            </a-button>
          </a-form-item></a-col
        >
